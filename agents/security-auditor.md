...
- **Local augmentation:** if the runtime adds a security-specific wrapper, keep it aligned with this repo baseline rather than duplicating contradictory security guidance
