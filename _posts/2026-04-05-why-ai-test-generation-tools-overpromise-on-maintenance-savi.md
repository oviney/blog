...
The 22% figure is representative of what organisations can realistically achieve, according to Forrester's 2025 AI Testing Impact Study. It is a worthwhile improvement — and it aligns with IEEE's finding that meaningful gains cluster among teams with mature CI/CD pipelines and dedicated test engineering roles. It is not the transformation that $1.2 billion in venture funding was raised to deliver.
